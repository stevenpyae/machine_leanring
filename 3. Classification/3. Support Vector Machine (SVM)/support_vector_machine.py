# -*- coding: utf-8 -*-
"""
Created on Fri May 28 17:36:20 2021
...
classifier = SVC(kernel = 'linear', random_state = 0) #Parameters - Kernel, Linear Kernel, Non-linear Kernel
...
print(cm)
# 65 correct of class 0, 2 incorrect of class 1 (bought but predicted not buy)
# 24 correct of class 1, 8 incorrect of class 0 (didn't buy but predicted buy)
print(accuracy_score(y_test, y_pred))
# Accuracy of 0.9
# Didin't Beat the K-NN because its still a Linear SVM
