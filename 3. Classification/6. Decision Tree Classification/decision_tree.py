# -*- coding: utf-8 -*-
"""
Created on Fri May 28 22:17:09 2021
...
classifier = DecisionTreeClassifier(criterion = 'entropy', random_state = 0) #Criterion = 'Entropy'
# Lots of parameters, Tuning later on, Need to read. 
...
print(cm)
# 62 correct of class 0, 6 incorrect of class 1 (bought but predicted not buy)
# 29 correct of class 1, 3 incorrect of class 0 (didn't buy but predicted buy)
